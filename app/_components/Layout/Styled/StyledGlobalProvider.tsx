...
body {
  background:
    radial-gradient(circle at 16% 0%, ${({ theme }) => theme.colors.brandTransparent}, transparent 28%),
    radial-gradient(circle at 84% 16%, rgba(34, 211, 238, 0.13), transparent 26%),
    ${({ theme }) => theme.colors.background01};
...
::-webkit-scrollbar-thumb {
  background-color: ${({ theme }) => theme.colors.brandTransparent};
