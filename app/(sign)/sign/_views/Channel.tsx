...
import cimeFind from "@/lib/cimeFind";
      ...
      <ContainerCenter>
        ...
        <Inputs>
          <MainInput
            type="text"
            value={url}
            placeholder="ex) https://ci.me/@byeolha/live"
            style={{ flex: 1 }}
            onChange={(event) => {
