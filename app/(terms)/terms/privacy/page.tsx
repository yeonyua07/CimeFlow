...
export default function Page() {
  return (
    <Container>
      <PageTitle>CimeFlow 개인정보 처리방침</PageTitle>
      <ContainerCenter>
        <Text>
          CimeFlow는 정보주체의 자유와 권리 보호를 위해 「개인정보 보호법」 및
        ...
        <Text>
          CimeFlow는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는
        ...
        <Text>CimeFlow는 다음의 개인정보 항목을 처리하고 있습니다.</Text>
        <OrderedList>
          <li>
        ...
        <Text>
          CimeFlow는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
        ...
        <Text>
          CimeFlow는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
        ...
        <Text>
          CimeFlow는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
          있습니다.
        </Text>
        <OrderedList>
          <li>
        ...
        <Text>
          CimeFlow는 Google Analytics를 통해 이용통계 정보를 수집·분석하고
          있습니다.
        </Text>
        <Text>
        ...
        <Text>
          CimeFlow는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
